                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label class="radio-inline">
                            <input type="radio" name="kind" value="ご意見" checked/>ご意見
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="kind" value="ご質問"/>ご質問
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <div class="pull-right">
                            <button class="btn btn-primary" type="submit"><i class="glyphicon glyphicon-plane"></i>　送信</button>
                            <button class="btn btn-default" type="reset"><i class="glyphicon glyphicon-thumbs-down"></i>　リセット</button>
                        </div>
                    </div>
                </div>
